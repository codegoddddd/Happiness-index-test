...
selectClass.append(`<option>${"12-22"}</option>`);
selectClass.append(`<option>${"23-40"}</option>`);
selectClass.append(`<option>${"41-60"}</option>`);
selectClass.append(`<option>${"61-90"}</option>`);
